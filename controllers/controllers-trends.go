...
func GetDailyTrends(w http.ResponseWriter, r *http.Request) {
	fmt.Fprint(w, "Daily trending searches:")
...
func GetRealTimeTrends(w http.ResponseWriter, r *http.Request) {
...
func GetAvailableCategories(w http.ResponseWriter, r *http.Request) {
...
func GetCompareKeywords(w http.ResponseWriter, r *http.Request) {
...
func GetExploreSearch(w http.ResponseWriter, r *http.Request) {
